<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ofertasPagosUnicos.aspx.cs" Inherits="WebPage.ofertasPagosUnicos" %>
...
<body>
    ...
    <style>
        ...
        @media (max-width: 1000px) {
            ...
            .plans-unic > div:nth-child(1) {
                order: 2;
            }

            .plans-unic > div:nth-child(2) {
                order: 1; /* Este se va primero */
            }

            .plans-unic > div:nth-child(3) {
                order: 3;
            }
        }
