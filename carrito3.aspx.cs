...
namespace WebPage
{
    public partial class carrito3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string strIdCliente = codes[0];

            //Referencia unica para el pago.
            _strReferencia = strIdCliente + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + "tiendafp";
            ...
            //string strString = Convert.ToBase64String(Encoding.Unicode.GetBytes(strIdCliente));

            //_strRedireccion = "https://fitnesspeoplecolomnbia.com/carrito4?guid=" + Session["guid"].ToString();
            _strRedireccion = "https://localhost:44382/carrito4?guid=" + Session["guid"].ToString();
        }
