<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ofertasMasVendidos.aspx.cs" Inherits="WebPage.ofertasMasVendidos" %>
                ...
                <div class="col-md-4" style="padding: 0;">
                    <div class="plan plan-oferta plan-tall plan-tall-oferta">
                        ...
                        <div class="plan-info">
                            ...
                            <p style="margin-bottom: 0;">Entrena en todas nuestra sedes.</p>

                            <p class="plan-price">$ 19.900 1er Mes</p>
                            <p class="plan-title" style="font-size: 15px;">+ $ 9.950 de Inscripción</p>
                ...
                <div class="col-md-4" style="padding: 0;">
                    <div class="plan plan-oferta plan-tall-2">
                        ...
                        <div class="plan-info">
                            ...
                            <p class="plan-price">$ 92.400 1er Mes</p>
                            <p class="plan-title" style="font-size: 15px;">+ $ 9.900 de Inscripción</p>
