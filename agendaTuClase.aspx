<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agendaTuClase.aspx.cs" Inherits="WebPage.agendaTuClase" %>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txbFechaIni" CssClass="form-control" runat="server" name="txbFechaIni" required=""></asp:TextBox>
                        </div>
                    </div>
                </div>
